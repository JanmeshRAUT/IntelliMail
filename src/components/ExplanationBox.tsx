      ...
      {isExpanded && (
        <div className="space-y-4">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <div className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-4">
              <p className="text-xs font-bold uppercase tracking-[0.18em] text-[var(--muted-foreground)] mb-2">Threat Summary</p>
                  ...
                  <div key={idx} className="rounded-xl border border-[var(--border)] bg-[var(--background)] p-3">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <div className="flex flex-wrap gap-2 shrink-0 justify-end">
                        {link.trustedDomain && <span className="rounded-full bg-emerald-100 px-2 py-1 text-[10px] font-bold uppercase tracking-wide text-emerald-700">Trusted</span>}
