        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          <div className="flex flex-col gap-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                <h1 className="text-4xl font-extrabold tracking-tight text-[var(--foreground)]">Gmail Security Monitor</h1>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className={cn(
                ...
                <p className={cn(
                  "text-2xl font-black",
                  threatStats.high > 0 ? "text-orange-600 dark:text-orange-400" : "text-[var(--muted-foreground)]"
                )}>{threatStats.high}</p>
